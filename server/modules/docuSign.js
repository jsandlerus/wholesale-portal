...
function configureJWTAuthorizationFlow(privateKeyFilename, oAuthBasePath, clientId, userId, expiresIn, callback){

};

module.exports = configureJWTAuthorizationFlow;